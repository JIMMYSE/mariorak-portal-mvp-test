...
import { REGEXP_TRAINEE_NAME } from 'src/types/util/regex';
...
// DTO 선언
export type BookmarkSearchResType = InferType<typeof BookmarkSearchRes>;
...
export const useBookmarkList = ({
  ...
  return useQueryFetch<BookmarkSearchResType>({
    url: API_URL + '/list',
    queryOption,
    queryKeyName,
  });
