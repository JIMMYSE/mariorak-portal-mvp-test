...
<template>
  <q-page class="px-6 pt-[10px] bg-grey">
    ...
    <section class="mt-[42px]">
      ...
      <c-body-text>text text text</a-body-text>
    </section>

    <section class="py-5 grid grid-cols-1 gap-5">
      <div>
        <c-subtitle>수료증서 및 상장수여</a-subtitle>
      ...
      <div class="">
        <c-subtitle>우리의 다짐 제창</a-subtitle>
        <div class="flex gap-[7px] mt-[5px]">
