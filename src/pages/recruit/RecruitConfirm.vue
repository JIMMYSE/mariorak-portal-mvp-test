...
<template>
  <q-page>
      ...
      <div class="flex flex-col">
        <div class="flex items-center pb-[15px]">
          ...
          <div class="flex flex-col ml-[12px]">
            ...
            <p class="text-[#056bf1] text-xs font-semibold leading-none mt-[2px]">개발자입니다람쥐~</p>
            <p class="flex items-center mt-[2px]">
              ...
              <span class="text-[#b5b5b5] text-xs font-normal leading-none">프로젝트 1000회</span>
            </p>
          </div>
        </div>
        <div class="mt-[12px]">
          <!-- <introduce-text /> 데이터 연동 시 붙여야 함-->
          저희 프로젝트를 빛내줄 유능한 ‘프로그래머’와 ‘아티스트’를모집합니다! 총 5명의 참가자가 필요합니다. 프로젝트를
          위하여 필요한 작업은 이러며, 해당 내...
        </div>
        <div class="mt-[30px]">
    ...
    <section class="px-6 mt-[40px]">
      ...
      <div class="space-y-2 mt-[14px]">
        <div class="flex justify-start items-center">
          ...
          <span class="text-[#222222] text-sm font-normal leading-tight]">가나다라마바사</span>
        </div>
        <div class="flex justify-start items-center">
        ...
        <div class="flex justify-start items-center">
          ...
          <span class="text-[#222222] text-sm font-normal leading-tight">2024.02.02</span>
        </div>
      </div>
    </section>
    ...
    <section class="bottom-[85px] w-full text-center px-6 mt-[85px] mb-6">
      <c-btn class="rounded-[10px] font-semibold text-base w-full py-[14px] bottom-0" color="primary" outline
        >거절
      </c-btn>
      <c-btn class="rounded-[10px] font-semibold text-base w-full py-[14px] bottom-0" color="primary">수락 </c-btn>
    </section>
  </q-page>
</template>
