...
const detail = ref({
  ...
  images: [
    { id: 1, imageUrl: '/images/dummy/main_dummy1.svg', sortOrder: 1 },
    { id: 2, imageUrl: '/images/dummy/main_dummy2.svg', sortOrder: 2 },
    { id: 3, imageUrl: '/images/dummy/main_dummy3.svg', sortOrder: 3 },
    { id: 4, imageUrl: '/images/dummy/main_dummy4.svg', sortOrder: 4 },
  ],
  goods: [
    { id: 1, title: '한정판 피규어', price: 10000, imageUrl: '/images/dummy/main_dummy1.svg' },
    { id: 2, title: '한정판 피규어', price: 10000, imageUrl: '/images/dummy/main_dummy2.svg' },
  ],
});
...
<template>
  <q-page class="bg-white">
    ...
    <div class="px-4 py-4">
      ...
      <div class="flex flex-col gap-1 mb-3">
        <div class="flex items-center gap-2">
          <q-icon name="img:/icons/icon_plan-20.svg" size="20px" v-if="false" />
      ...
      <!-- 스토어 안내 -->
      <div class="mb-4">
        <h3 class="text-[16px] font-semibold text-grey-5 mb-2">스토어 안내</h3>
    ...
    <q-tab-panels v-model="activeTab" animated class="bg-white">
      ...
      <!-- goods 탭 -->
      <q-tab-panel name="goods" class="px-4">
        <div class="grid grid-cols-2 gap-4">
          <div v-for="goods in detail.goods" :key="goods.id" class="flex flex-col">
            <div class="rounded-lg overflow-hidden h-[217px]">
              <q-img :src="goods.imageUrl" class="w-full h-full" fit="cover" />
            </div>
            <p class="text-[14px] text-grey-5 mt-2">{{ goods.title }} &#8361; {{ goods.price.toLocaleString() }}</p>
          </div>
        </div>
      </q-tab-panel>
    </q-tab-panels>
